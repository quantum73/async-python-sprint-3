...
SERVER_MESSAGE_TEMPLATE = "{server_obj} {message}"
BAN_MESSAGE_TEMPLATE = "You banned to {banned_to}"
BLOCK_CHATING_MESSAGE_TEMPLATE = "You have no message limit to {block_to}"
...
MESSAGE_LIMIT = server_config.get("message_limit", 20)
